...
const PublicFooter: React.FC = () => {
  ...
  const socialLinks = [
    { name: 'Twitter', icon: Twitter, href: 'https://x.com/BISWAJI50516858?s=09' },
    { name: 'Instagram', icon: Instagram, href: 'https://www.instagram.com/biswajit1.yt?igsh=MWp6eXEzanB6NG1nNA==' },
    { name: 'LinkedIn', icon: Linkedin, href: 'https://www.linkedin.com/in/biswajit-sahoo-062199387?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app' }
  ];
        ...
        <div className="glass-card p-6 sm:p-8 rounded-xl sm:rounded-2xl">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6 sm:gap-8">
            ...
            <div className="sm:col-span-2 lg:col-span-2">
              <Link to="/" className="flex items-center space-x-2 sm:space-x-3 mb-4">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">SocialPilot</span>
              </Link>
          ...
          <div className="border-t border-white/20 mt-6 sm:mt-8 pt-6 sm:pt-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
              <div className="flex items-center space-x-2 text-white/70">
                ...
                <span className="text-xs sm:text-sm truncate">socialpilotai01@gmail.com</span>
              </div>
              <div className="flex items-center space-x-2 text-white/70">
                <Phone className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                <span className="text-xs sm:text-sm">+91 7077430498</span>
              </div>
              <div className="flex items-center space-x-2 text-white/70">
                <MapPin className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                <span className="text-xs sm:text-sm">Bhubaneswar,OD</span>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-white/20 pt-4 sm:pt-6 flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
            <p className="text-white/60 text-xs sm:text-sm text-center sm:text-left">
              © {currentYear} SocialPilot. All rights reserved.
            </p>
