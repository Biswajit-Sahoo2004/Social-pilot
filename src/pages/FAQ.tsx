  ...
  const faqs = [
    {
      ...
      question: 'How do I get started with SocialPilot?',
    ...
    },
    {
      id: 2,
      category: 'getting-started',
      question: 'Which social media platforms does SocialPilot support?',
    ...
    },
    {
      id: 8,
      category: 'features',
      question: 'Does SocialPilot provide analytics?',
    ...
    },
    {
      id: 9,
      category: 'technical',
      question: 'Is my data secure with SocialPilot?',
    ...
    },
    {
      ...
      answer: 'Yes! Our Zapier integration allows you to connect SocialPilot with over 3,000 apps to automate your workflows.'
    }
  ];
    ...
    <div className="space-y-20 px-6 py-12">
      ...
      <section className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-white/80 leading-relaxed mb-8">
          Find answers to common questions about SocialPilot, or get in touch with our support team.
        </p>
      ...
      <section className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/70">
            Guides, tutorials, and documentation to help you get the most out of SocialPilot
          </p>
        </div>
      ...
      <section className="max-w-4xl mx-auto text-center">
        <div className="glass-card p-12 rounded-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="mailto:socialpilotai01@gmail.com"
