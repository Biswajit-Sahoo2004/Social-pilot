...
const Homepage: React.FC = () => {
  ...
  const testimonials = [
    {
      ...
      content: 'Socialpilot has transformed our social media strategy. We\'ve seen a 300% increase in engagement since switching.',
      rating: 5,
  ...
  const stats = [
    ...
    { number: '00', label: 'Posts Scheduled' },
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="glass-card p-6 sm:p-8 lg:p-12 rounded-xl sm:rounded-2xl">
            ...
            <p className="responsive-text-lg sm:text-xl text-white/80 mb-6 sm:mb-8 px-4">
              Join thousands of businesses already using Socialpilot to grow their online presence.
            </p>
