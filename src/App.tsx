...
import { AuthProvider, useAuth } from './context/UserSessionProvider';
import { useLocalStorage } from './hook/LocalStorage';
import ProtectedRoute from './components/SecureRoute';
import LogoutModal from './components/ConfirmLogoutModal';
import PostModal from './components/PostComposerModal';
import PublicLayout from './components/MainLayout';
      ...
      <div className="glass-panel px-3 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-full">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-white font-semibold text-sm sm:text-lg">Socialpilot</span>
          </div>
      ...
      <Router>
        <div className="App">
          <Routes>
            ...
            <Route path="/" element={
              <PublicLayout 
                title="SocialPilot - Social Media Management Made Simple"
            ...
            <Route path="/about" element={
              <PublicLayout 
                title="About Us - SocialPilot"
                description="Learn about SocialPilot's mission to democratize social media success and meet the team behind the platform."
              >
                <AboutUs />
              </PublicLayout>
            } />
            ...
            <Route path="/faq" element={
              <PublicLayout 
                title="FAQ - SocialPilot"
                description="Find answers to common questions about SocialPilot features, billing, integrations, and technical support."
              >
                <FAQ />
              </PublicLayout>
            } />
